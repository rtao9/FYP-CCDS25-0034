...
import pickle
import argparse
from mmagent.utils.retrieve import translate
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mem_path", type=str, default="data/EgoLife/memory_graphs/EgoLife.pkl")
    parser.add_argument("--clip_id", type=int, default=11213000)
